...
import SocialButton from "~/components/layouts/SocialButton.vue";
...
<template>
  ...
  <div class="fixed bottom-0 left-0 z-50 w-full h-16 bg-white border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600" v-if="route.name === 'index'">
    <div class="grid h-full max-w-lg grid-cols-3 mx-auto font-medium">
      ...
      <button type="button" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
        ...
        <span class="text-sm text-green-900 dark:text-green-900 group-hover:text-green-600 dark:group-hover:text-blue-500">Profile</span>
      </button>
    </div>
  </div>
